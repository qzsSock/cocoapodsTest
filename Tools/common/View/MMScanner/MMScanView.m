...
- (void)layoutSubviews {
    ...
    //luojiao
    _lineImageView.frame = CGRectMake(Left, YMinRetangle + 2 - 50, sizeRetangle.width - 4, 5);
...
- (void)startAnimating {
    ...
    //luojiao
    CGRect initFrame = CGRectMake(Left, YMinRetangle + 2 - 50, sizeRetangle.width - 4, 5);
    ...
    [UIView animateWithDuration:1.5 animations:^{
        //luojiao
        _lineImageView.frame = CGRectMake(initFrame.origin.x, YMaxRetangle - 2 - 50, initFrame.size.width, initFrame.size.height);
...
- (void)drawScanRect {
    ...
    CGSize sizeRetangle = CGSizeMake(self.frame.size.width - Left * 2, self.frame.size.width - Left * 2);
    //luojiao
    CGFloat YMinRetangle = self.frame.size.height / 2.0 - sizeRetangle.height/(2.0 * _heightScale) - 50;
